...
import com.hgapplication.to_do_list.adapters.ItemsListAdapters
...
// Used for filtering inside Broadcast receiver
        ...
        val item_id = items.id.toInt()
        intent.action = "MyBroadcastReceiverAction"

        val pendingIntent = PendingIntent.getBroadcast(context, item_id, intent, PendingIntent.FLAG_MUTABLE)
