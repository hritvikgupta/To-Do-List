...
import com.hgapplication.to_do_list.adapters.TaskListAdapters
import com.hgapplication.to_do_list.model.CurrentTask
import com.hgapplication.to_do_list.model.LoginState
import com.hgapplication.to_do_list.model.Tasks
import com.hgapplication.to_do_list.viewmodel.MainViewModel
import com.hgapplication.to_do_list.viewmodel.itemsViewModel
import com.hgapplication.to_do_list.viewmodel.saveListViewModel
...
class mainFragment : Fragment(), MenuProvider{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
            ...
            (activity as AppCompatActivity).window.statusBarColor = Color.parseColor("#ECEFF1")
        ...
        //(activity as AppCompatActivity).supportActionBar?.title = LoginState.user?.username
            ...
            ItemsViewModel = androidx.lifecycle.ViewModelProvider(this)[com.hgapplication.to_do_list.viewmodel.itemsViewModel::class.java]
            observeModel()
    ...
    fun observeModel(){
        viewmodel.signout.observe(viewLifecycleOwner, Observer {
            ...
            Navigation.findNavController(usernameTV).navigate(R.id.actionGoToLogin)
